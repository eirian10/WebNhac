...
if (isset($_GET['id_baihat'])) {
    ...
    $id_casi = $singerInfo['id_casi']; // Thay `id_casi` bằng tên cột thực tế trong cơ sở dữ liệu
...
<body>
    ...
    <div class="container">
        ...
        <div class="main-song">
            ...
            <div class="song-info show-main"  data-id_baihat="<?php echo $row_idbaihat['id_baihat']; ?>">
                ...
                ?>
                        <div class="song-item">
                            <div class="song-card list-card" data-audio="<?php echo $row['linknhac']; ?>">
                                ...
                                <div class="info-song-hidden-list" data-id_baihat="<?php echo $row['id_baihat']; ?>">
    ...
    <div class="container-singer">
        <?php if ($singerInfo): ?>
<a href="chitiet.php?id=<?php echo (int)$id_casi; ?>">
    ...
    <script>
        ...
        function updateMainSong(card) {
            ...
            mainSongInfo.setAttribute('data-id_baihat', card.querySelector('.info-song-hidden-list').getAttribute('data-id_baihat'));
